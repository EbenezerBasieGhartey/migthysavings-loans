...
{
  if (!$con->query("insert into useraccounts (name,next_of_kin,accountNo,accountType,city,address,email,password,balance,occupation,number,branch) values ('$_POST[name]','$_POST[next_of_kin]','$_POST[accountNo]','$_POST[accountType]','$_POST[city]','$_POST[address]','$_POST[email]','$_POST[password]','$_POST[balance]','$_POST[occupation]','$_POST[number]','$_POST[branch]')")) {
    ...
    <table class="table">
      <tbody>
        <tr>
          ...
          <th>NEXT OF KIN</th>
          <td><input type="text" name="next_of_kin" class="form-control input-sm" required></td>
        </tr>
        <tr>
          <th>Account Number</th>
          <td><input type="" name="accountNo"
        ...
        <tr>
          ...
          <td><input type="number" name="balance" min="5" class="form-control input-sm" required></td>
          <th>Occupation</th>
        ...
        <tr>
         ...
         <tr>
          <th>Image</th>
          <td><input type="file" name="image" class="form-control input-sm" required ></td>
        </tr>
        <tr>
          <td colspan="4">
