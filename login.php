...
<head>
    ...
    define('bankName', 'Mighty Savings & Loans',true);
...
<body style="background: url(images/transfer.jpg);background-size: 100%;">
<h1 class="alert alert-success rounded-0"><img src="images/envelope.png" width="80" height="70" class="d-inline-block align-top" alt=""><?php echo "Mighty Savings and Loans"; ?><small class="float-right text-muted" style="font-size: 12pt;"></small></h1>
<br>
<?php echo $error ?>
<br>
